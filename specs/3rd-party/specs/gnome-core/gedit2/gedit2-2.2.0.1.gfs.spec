Name: gedit2
Summary: Gnome 2 text editor
Version: 2.2.0.1
Release: 1.gfs
License: GPL
Group: Productivity/Editors/Other
Source: ftp://ftp.gnome.org/pub/gnome/sources/gedit/2.2/gedit-%{version}.tar.bz2
BuildRoot: %{_tmppath}/build-root-%{name}
Requires: libglade2 >= 2
Requires: eel2 >= 2.2
Requires: libgnomeui >= 2.2
Requires: libbonobo >= 2
Requires: libgnomeprintui >= 2.2
Requires: orbit2 >= 2
...
- initial build for The Gnome fo SuSE Project <2.2.0.1>