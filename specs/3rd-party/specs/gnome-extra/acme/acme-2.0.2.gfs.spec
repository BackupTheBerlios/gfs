Name: acme
Summary: Gnome 2 tool to enable multimedia buttons on modern keyboards
Version: 2.0.2
Release: 1.gfs
License: GPL
...
%description
Gnome 2 tool to enable multimedia buttons on modern keyboards
...
- initial build for The Gnome for SuSE Project <2.0.2>
